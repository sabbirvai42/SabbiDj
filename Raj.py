...
def mex():
    ...
    try:
        ...
        os.system('am start https://wa.me/+8801608002168?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20SABBI4%20Paid%20Tools.%20My%20Key:%20'+key1)
        mex()
    r = requests.get('https://wa.me/+8801608002168/SABBI4/approved.txt/main/approved.%20txt').text
    if key1 in r:
